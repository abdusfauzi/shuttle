...
Date (UTC): 2026-03-05_23-43-13Z
Host macOS: 26.3.1

1) Preflight checks
Checking AppleScript resources...
Checking terminal and mode support markers in AppServices.swift...
...
- Warp.app: installed | version=0.2026.02.25.08.24.01 (0.2026.02.25.08.24.01) | path=/Applications/Warp.app
