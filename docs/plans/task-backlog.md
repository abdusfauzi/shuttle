...
| M-004 | Execute full terminal behavior parity matrix across all open modes and supported terminals | Testing | in_progress | P0 | unassigned | 2026-03-14 | M-003 | 2026-03-06 | Matrix runbook was expanded with a step-by-step manual execution checklist and evidence capture requirements. Automation gates are healthy; manual per-cell validation remains. |
