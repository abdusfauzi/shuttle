...
| Terminal backend parity | 100% | Latest capture evidence is `tests/terminal-parity-matrix-capture-2026-03-06_04-26-53Z.md` (`20/20` pass) and parity tooling is now non-invasive by default. |
...
| 2026-03-06 | Non-invasive parity tooling closeout | done | App | Smoke and matrix parity tools are now safe-by-default and require explicit interactive opt-in for real terminal-window launches. |
